 ...
 *
 * <ul>
 * <li>Method that creates and returns a default non-blocking implementation of
 * the {@link Pool} interface.
 * <li>Method that creates and returns a default implementation of the
...
public final class PoolFactory {
     ...
     * {@link BlockingPool}, whose size is limited by the <TT>size</TT>
     * parameter.
     * 
     * @param size
    ...
    /**
     * Creates a and returns a new object pool, that is an implementation of the
     * {@link Pool} whose size is limited by the <TT>size</TT> parameter.
     * 
     * @param size
     *            the number of objects in the pool.
     * @param factory
